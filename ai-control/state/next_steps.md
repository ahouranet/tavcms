...
- [ ] Phase0-04: ساخت اپ `core` با قراردادها:
...
- [ ] Phase0-05: ساخت مدل تنظیمات singleton در core (default language, lang→calendar, slug_max_len, prefix_default_lang)
- [ ] Phase0-06: تست‌های حداقلی برای slug و dates و i18n prefix
- [ ] Phase0-07: ADR جدید: «Shared contracts & no re-implementation»
